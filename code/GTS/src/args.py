...
def build_parser():
	...
	# Model parameters
	parser.add_argument('-embedding', type=str, default='bert', choices=['bert', 'roberta'],
						help='Embeddings')
	parser.add_argument('-emb_name', type=str, default='bert-base-uncased', choices=['bert-base-uncased', 'roberta-base'],
						help='Which pre-trained model')
